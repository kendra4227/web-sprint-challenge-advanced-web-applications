...
Answer:A token is used for token-based authentication to allow access to the API.
2. What steps can you take in your web apps to keep your data secure?
Answer:By creating private routes
3. Describe how web servers work.
Answer:Web servers store the code for a website and then share to a localhost.
4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers. 
Answer: PUT can map to both Create and Update depending on the existence of the URI used with the PUT.
